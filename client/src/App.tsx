      ...
      <Route path="/">
        <div className="flex items-center justify-center min-h-screen bg-neutral-50 p-4">
          <div className="bg-white rounded-xl p-6 max-w-md w-full shadow-card">
            ...
            <h3 className="text-center font-heading font-semibold text-xl mb-2">Plateforme ECOS</h3>
            <p className="text-center text-neutral-600 mb-6">
              Plateforme d'entraînement et d'évaluation pour les examens cliniques objectifs structurés.
            </p>
