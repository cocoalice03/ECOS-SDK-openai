...
export default function StudentPage({ email: propEmail }: StudentPageProps) {
  ...
  const handleStartSession = (scenarioId: number) => {
    if (startSessionMutation.isPending) return; // Éviter les clics multiples
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 py-3 sm:py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
            <div className="min-w-0">
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Dashboard Étudiant ECOS</h1>
              <p className="text-sm sm:text-base text-gray-600 truncate">Bienvenue, {decodedEmail}</p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 py-3 sm:py-6">
        <section className="hero bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg mb-4 sm:mb-8">
            ...
            <div className="hero-content flex flex-col lg:flex-row lg:items-center gap-6 sm:gap-12">
              <div className="flex-1 order-2 lg:order-1">
                <div className="hero-text">
                  <h2 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3 sm:mb-4">L'Avenir de la Formation Médicale</h2>
        ...
        <Tabs defaultValue="scenarios" className="w-full">
          <TabsList className="grid w-full grid-cols-2 h-12 sm:h-20 p-1 sm:p-2">
            <TabsTrigger value="scenarios" className="h-10 sm:h-16 px-2 sm:px-8 py-2 sm:py-4 mx-0.5 sm:mx-1 tabs-trigger-enhanced text-xs sm:text-base">
              <span className="hidden sm:inline">Nouveaux Examens</span>
              <span className="sm:hidden">Examens</span>
            </TabsTrigger>
            <TabsTrigger value="history" className="h-10 sm:h-16 px-2 sm:px-8 py-2 sm:py-4 mx-0.5 sm:mx-1 tabs-trigger-enhanced text-xs sm:text-base">
              Historique
            </TabsTrigger>
          </TabsList>
